...
GEODIR="/home/ubuntu/naca_airfoil/geo_files"
# Path to dir where msh files will be stored
MSHDIR="/home/ubuntu/naca_airfoil/msh_files"
...
do
  ...
  /home/ubuntu/naca_airfoil/naca2gmsh_geo.py $NACA1 $NACA2 $NACA3 $NACA4 $angle $n_nodes > $GEODIR/$geofile
done
